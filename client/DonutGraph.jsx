...
const DonutGraph = ({ monthlyPayment, principalPercentage, homeInsurancePercentage, propertyTaxPercentage, mortgageETCPercentage }) => (
  ...
  <Styles.InnerChartContainer className="InnerContainer">
    ...
    <Styles.SVGViewBox viewBox="0 0 40 40">
      <circle class="donut-ring" cx="18" cy="18" r="15.91549430918954" fill="transparent" stroke="rgb(5, 34, 134)" stroke-width="3.8"></circle>
